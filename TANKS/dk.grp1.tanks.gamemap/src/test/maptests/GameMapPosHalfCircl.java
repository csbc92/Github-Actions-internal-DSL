...
import dk.grp1.tanks.gamemap.internal.GameMapPositiveHalfCircle;
...
public class GameMapPosHalfCircl {


    @Test(expected = IllegalArgumentException.class)
    public void testCreateNull() {
        GameMapPositiveHalfCircle map = new GameMapPositiveHalfCircle(0, 1, null, 5);

    }

    @Test(expected = IllegalArgumentException.class)
    public void testCreateCenterXOutOFRange() {
        GameMapPositiveHalfCircle map = new GameMapPositiveHalfCircle(10, 20, 100, 5, 5);

    }

    @Test(expected = IllegalArgumentException.class)
    public void testCreateCenterStartOutOFRange() {
        GameMapPositiveHalfCircle map = new GameMapPositiveHalfCircle(10, 20, 15, 5, 2);
    ...
    public void testGetStartX() {
        float startX = 0;
        GameMapPositiveHalfCircle map = new GameMapPositiveHalfCircle(startX, 20, 15, 5, 5);
    ...
    public void testGetYValue() {
        float startX = 0;
        GameMapPositiveHalfCircle map = new GameMapPositiveHalfCircle(10, 20, 15, 5, 5);
        Assert.assertEquals(map.getYValue(15), 10, 0.005);
    ...
    public void testCreateStartXgreaterThanEndX() {
        float startX = 100;
        float endX = 20;
        GameMapPositiveHalfCircle map = new GameMapPositiveHalfCircle(startX, endX, 15, 5, 5);
    }
    ...
    public void testSetEndX() {
        float startX = 50;
        float endX = 65;
        GameMapPositiveHalfCircle map = new GameMapPositiveHalfCircle(startX, endX, 15, 5, 50);
        float newEndX = 60;
        map.setEndX(newEndX);
